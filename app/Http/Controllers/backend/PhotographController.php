...
class PhotographController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.photographs.create', compact('authors'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            request()->postImg->move(public_path('img/photographs/'), $postImg);
        } catch (Exception $e) {
    ...
    public function edit($id)
    {
        $post = Post::find($id);
        $authors = Author::where('status', 1)->get();
        return view('admin.photographs.create', compact('authors', 'post'));
    }
