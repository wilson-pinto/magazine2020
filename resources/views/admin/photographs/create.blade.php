...
<div class="col-md-12 mt-2">
    <div class="content-body bg-white shadow px-5 py-4">
        ...
        <form method="post" enctype="multipart/form-data"
            ...
            <form method="post" enctype="multipart/form-data" action="{{ route('admin.photographs.store') }}">
                @endif
                {{ csrf_field() }}
                ...
                <div class="form-group row px-3">
                    ...
                    <img src="{{isset($post) ? '/img/photographs/'. $post->img_url : ''}}" class="mt-4" height="50px">
                </div>
